...
4. **Commit changes** - All code changes should be committed
5. **Hand off** - Provide context for next session

**CRITICAL RULES:**
- NEVER push to remote automatically - let the user decide when to push
- Commit work locally so it's not lost
- Beads daemon handles syncing beads changes automatically
