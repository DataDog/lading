/// A program whose sole purpose is to generate 1Gb of DogStatsD load and then
/// exit. It's like having criterion benchmarks without having to split
/// `lading::payload` into a crate.
///
/// I'm not sure how this will interact with the release process. We probably
/// should disable this binary at some point.
use lading::payload::dogstatsd;
