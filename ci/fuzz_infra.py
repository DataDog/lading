...
If you want to run this locally, please set the VAULT_FUZZING_TOKEN environment variable (i.e: ddtool auth token security-fuzzing-platform --datacenter=us1.ddbuild.io)
...
DEFAULT_FUZZING_SLACK_CHANNEL = "single-machine-performance-backroom"
